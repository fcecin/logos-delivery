...
# REST suites run docker nodes from DEFAULT_NWAKU (default: the nightly image, rebuilt from master
# each night); the messaging suite needs an image built from this branch, with "nwaku" in its name
