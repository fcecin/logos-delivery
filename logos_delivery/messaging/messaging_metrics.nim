...
##
## nim-metrics appends `_total` to every counter on export, so the names below
## carry no suffix: `logos_delivery_recv_messages` is scraped as
## `logos_delivery_recv_messages_total`.
