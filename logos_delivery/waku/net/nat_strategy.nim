...
## Logos Delivery's public NAT strategy vocabulary. NatStrategy holds the
## user intent of --nat. nat_config maps a strategy onto the NATService.
...
const DefaultNatDiscoveryTimeoutMs* = 1000'u32
  ## Node start awaits gateway discovery, and miniupnpc waits the full
  ## timeout per SSDP round. One second bounds the worst stall to seconds.
