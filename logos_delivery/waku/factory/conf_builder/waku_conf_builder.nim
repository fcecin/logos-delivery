...
proc build*(
  ...
  # The CLI defaults to "any". This embedded default stays "none", so
  # library nodes do not probe gateways unless configured to.
  ...
  ## Zero is a config error. The NATService's own rejection at switch
  ## build is opaque.
