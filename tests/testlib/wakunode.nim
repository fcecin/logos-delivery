...
proc newTestWakuNode*(
  ...
  # A dns4 name is announced as-is; a caller that needs the resolved IP in
  # the ENR resolves the name itself (an asyncTest can await dnsResolve)
  # and passes it as extIp.
